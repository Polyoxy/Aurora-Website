...
export default function HomeFooter() {
  return (
    <footer className="bg-white text-black py-12 sm:py-16">
      <div className="max-w-[85%] mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          {/* Logo and Tagline */}
          <div className="space-y-4">
            <div className="w-12 h-12 sm:w-16 sm:h-16 [&>svg]:fill-black">
            ...
            <p className="text-base sm:text-lg text-black/60 max-w-xs">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services/branding" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Branding</Link></li>
              <li><Link href="/services/web-development" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Web Development</Link></li>
              <li><Link href="/services/product-design" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Product Design</Link></li>
              <li><Link href="/services/digital-marketing" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Digital Marketing</Link></li>
              <li><Link href="/services/software-development" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Software Development</Link></li>
              <li><Link href="/services/ai-solutions" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">AI Solutions</Link></li>
              <li><Link href="/services/seo" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">SEO</Link></li>
              <li><Link href="/services/analytics" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Analytics</Link></li>
              <li><Link href="/services/print-design" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Print Design</Link></li>
              <li><Link href="/services/business-cards" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Business Cards</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">About Us</Link></li>
              <li><Link href="/work" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Our Work</Link></li>
              <li><Link href="/careers" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Careers</Link></li>
              <li><Link href="/contact" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">LinkedIn</a></li>
              <li><a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Twitter</a></li>
              <li><a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Instagram</a></li>
              <li><a href="https://behance.net" target="_blank" rel="noopener noreferrer" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Behance</a></li>
            </ul>
          </div>
        </div>

        {/* Bottom Bar */}
        <div className="mt-12 sm:mt-16 pt-8 sm:pt-12 border-t border-black/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-base sm:text-lg text-black/60">
            ©Aurora 2020 - {new Date().getFullYear()}. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href="/privacy" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-base sm:text-lg text-black/60 hover:text-black transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
