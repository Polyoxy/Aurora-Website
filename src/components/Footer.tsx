        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/work" className="text-gray-400 hover:text-orange-500 transition-colors">
                  Work
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/clients" className="text-gray-400 hover:text-orange-500 transition-colors">
                  Clients
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/strategy" className="text-gray-400 hover:text-orange-500 transition-colors">
                  Strategy
                </Link>
              </li>
              <li>
                <Link href="/services/design" className="text-gray-400 hover:text-orange-500 transition-colors">
                  Design
                </Link>
              </li>
              <li>
                <Link href="/services/development" className="text-gray-400 hover:text-orange-500 transition-colors">
                  Development
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <Link 
              href="/contact" 
              className="inline-block px-5 py-2.5 rounded-full bg-orange-500 text-white font-medium hover:bg-orange-600 transition-colors"
            >
              Let's Collaborate
            </Link>
          </div>
