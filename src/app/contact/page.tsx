              ...
              {isSubmitted ? (
                <div className="text-center py-8">
                  <motion.div
                    ...
                    className="w-16 h-16 bg-gray-700 rounded-full mx-auto flex items-center justify-center mb-6"
                  >
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent text-white"
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-gray-700 text-white rounded-full font-medium hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-10 h-10 rounded-full bg-gray-800/10 flex items-center justify-center mr-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@aurora.com" className="text-gray-400 hover:text-white transition-colors">
                        hello@aurora.com
                      </a>
                    </div>
                  </div>
